...
export default function MobileHomePage() {
    ...
    // Tasks with pending validation (visit report submitted, awaiting admin review)
    const tasksPendingValidation = useMemo(() => {
        if (!dashboardData?.pendingVisitAssetIds) return [];
        return dashboardData.pendingVisitAssetIds;
    }, [dashboardData]);
                    ...
                    {sortedTasks.length === 0 ? (
                        ...
                        <div className="space-y-3">
                            {sortedTasks.map((task) => {
                                ...
                                const isPendingValidation = tasksPendingValidation.includes(task.id);
